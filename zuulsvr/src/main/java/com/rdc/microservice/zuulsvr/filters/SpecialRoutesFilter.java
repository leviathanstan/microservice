package com.rdc.microservice.zuulsvr.filters;


import com.netflix.zuul.ZuulFilter;
import com.netflix.zuul.context.RequestContext;
import com.rdc.microservice.zuulsvr.model.AbTestingRoute;
...
public class SpecialRoutesFilter extends ZuulFilter {
    ...
    private AbTestingRoute getAbRoutingInfo(String serviceName) {
        ...
        try {
            restExchange = restTemplate.exchange(
                             "http://sproute/v1/route/abtesting/{serviceName}",
                             HttpMethod.GET,
    ...
    public Object run() {
        ...
        //对sproute调用，确定目前服务id是否有路由
        AbTestingRoute abTestRoute = getAbRoutingInfo(filterUtils.getServiceId());
        //是否需要路由到sproute服务
        System.out.println(abTestRoute);
        if (abTestRoute != null && useSpecialRoute(abTestRoute)) {
            System.out.println("sproute");
